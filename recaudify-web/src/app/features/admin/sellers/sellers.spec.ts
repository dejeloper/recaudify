...
const sample: Seller = { id: 1, name: 'Juan Vendedor', username: 'juan.v', active: true };

async function setup() {
  const service = {
    items: signal<Seller[]>([]),
    trashed: signal<Seller[]>([]),
